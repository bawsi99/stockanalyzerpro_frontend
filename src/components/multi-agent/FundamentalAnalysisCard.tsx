...
export const FundamentalAnalysisCard = () => (
  <Card className="bg-gradient-to-br from-card to-secondary/30 border-primary/20 flex items-center justify-center min-h-[140px] relative">
    ...
    <CardHeader className="pb-2 items-center text-center">
      <div className="flex items-center gap-3">
        ...
        <CardTitle className="text-xl">Fundamental Analysis</CardTitle>
      </div>
      <CardDescription>Earnings, valuation, balance sheet, cash flow</CardDescription>
    </CardHeader>
  </Card>
);
